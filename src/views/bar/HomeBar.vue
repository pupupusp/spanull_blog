<template>
	<div class="home-bar">
		<div class="bar-content">
			...
			<div class="right-btn">
				<n-button circle :bordered="false" class="margin-right-20">
					<template #icon>
						<n-icon size="30px"><Settings24Filled /></n-icon>
					</template>
				</n-button>
					...
					default: () =>
						h(
							NImage,
							{
								...
								src: new URL(
									globalStore().theme == "light" ? "../../assets/logo_light.png" : "../../assets/logo_dark.png",
									import.meta.url
								).href,
								class: "head-logo",
							},
